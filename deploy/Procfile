...
#     echo '{ "name": "trevorsmith", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/trevorsmith/trevorsmith
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/trevorsmith/trevorsmith production -p $PORT
