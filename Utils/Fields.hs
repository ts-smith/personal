...
unsanitaryNicHtmlField :: YesodNic master => Field sub master Html
unsanitaryNicHtmlField = Field
    { fieldParse = \e _ -> return . Right . fmap (preEscapedText) . listToMaybe $ e
